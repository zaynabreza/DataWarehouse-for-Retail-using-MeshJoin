...
public class MeshJoin {
    ...
    private final Integer TransactionsTotal=10000;
    ...
    MeshJoin() throws ClassNotFoundException, SQLException {
        ...
        this.sourceConnect=DriverManager.getConnection("jdbc:mysql://localhost/projectsource?"+"user=root&password=1234&autoReconnect=true&useSSL=false");
        this.destConnect=DriverManager.getConnection("jdbc:mysql://localhost/dwh?"+"user=root&password=1234&autoReconnect=true&useSSL=false");
    }
    ...
    public int getTransactions(Integer id) throws SQLException {
        ...
        String sql = ("SELECT * FROM transactions where TRANSACTION_ID > ? ORDER BY TRANSACTION_ID ASC LIMIT 50;");
